...
javac --module-path "javafx-modules" --add-modules javafx.controls,javafx.media,javafx.swing,javafx.fxml,javafx.web,java.logging -cp "lib/jaudiotagger-3.0.1.jar:lib/jlayer-1.0.1.jar:lib/mp3agic-0.9.0.jar:lib/svg-salamander-1.1.5.3.jar:src" src/*.java -d bin
